...
export default function CoordinatorRegister() {
  ...
  return (
    <div className="min-h-screen bg-orange-50 py-8 px-4 sm:px-6 lg:px-8 animate-fade-in relative">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <nav className="flex items-center text-sm text-gray-500 mb-8">
          <Link to="/" className="hover:text-orange-600">{t('reg.home', 'Home')}</Link>
          <ChevronRight className="w-4 h-4 mx-2" />
          <Link to="/register" className="hover:text-orange-600">{t('reg.register', 'Register')}</Link>
          <ChevronRight className="w-4 h-4 mx-2" />
          <span className="font-medium text-gray-900">{t('reg.coordinatorTitle', 'Coordinator Registration')}</span>
        </nav>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="p-8 sm:p-12">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">{t('reg.coordinatorTitle', 'Coordinator Registration')}</h1>
                <p className="text-gray-500 mt-1">{t('reg.coordinatorSubtitle', 'Join as a coordinator to help deliver fresh produce')}</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">{t('reg.location', 'Location / Area')} *</label>
