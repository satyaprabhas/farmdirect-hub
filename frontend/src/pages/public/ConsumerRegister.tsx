...
export default function ConsumerRegister() {
  ...
  return (
    <div className="min-h-screen bg-blue-50 py-8 px-4 sm:px-6 lg:px-8 animate-fade-in">
      <div className="max-w-3xl mx-auto">
        ...
        <nav className="flex items-center text-sm text-gray-500 mb-8">
          ...
          <ChevronRight className="w-4 h-4 mx-2" />
          <span className="font-medium text-gray-900">Consumer Registration</span>
        </nav>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="p-8 sm:p-12">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Consumer Registration</h1>
                <p className="text-gray-500 mt-1">Create your account to buy fresh produce directly from farmers</p>
              </div>
            </div>
